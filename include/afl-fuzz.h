...
/*MFuzz*/
  u32 queued_mem_items;
  u32 queued_path_items;
  u32 is_mem;
  s32 offsets[32];
  u32 cur_offset;
  u32 mem1;
...
void write_memory_coverage_debug(afl_state_t *, u32 , u32 , u32 , u32 );
void write_memory_coverage(afl_state_t *);
